  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer: '我们采用多重验证机制：要求用户提供身份证明、学生证或工作证明；房源信息需提供实地照片和产权证明；定期进行房源信息更新和核实；对违规信息进行严格处罚。'
    },
    {
      question: '押金如何托管？何时退还？',
      answer: '押金由平台第三方支付系统托管，租约到期且无纠纷时自动解冻退还。如有纠纷，平台将介入调解，确保双方权益。'
    },
    {
      question: '求租人如何预约看房？',
      answer: '在房源详情页点击"预约看房"，选择合适时间，等待房东确认。确认后可获得具体地址和联系方式。'
    },
    {
      question: '转租人如何下架房源？',
      answer: '登录后台管理系统，在"我的房源"中选择相应房源，点击"下架"即可。如已有在谈租客，建议提前沟通。'
    },
    {
      question: '如果租客违约怎么办？',
      answer: '平台提供标准租约模板，明确双方权责。如遇违约，可提交相关证据，平台将介入调解，必要时可申请法律援助。'
    },
    {
      question: '平台收费标准是什么？',
      answer: '基础房源发布免费。成功租赁后收取成交金额的3%作为服务费。额外推广服务另收费，具体见收费说明。'
    },
    {
    ...
    {
      question: '平台提供哪些安全保障？',
      answer: '身份认证、押金托管、租约公证、纠纷调解、保险服务等全方位保障措施。详见平台安全保障协议。'
    }
  ];
